<template>
    <AnimationProductEnterGlow>
        <div
            class="flex bg-action-secondary dark:bg-dark-action-secondary rounded-2xl p-1.5 my-2.5 max-w-2xl grow-1 border-action-primary dark:border-dark-action-primary"
        >
