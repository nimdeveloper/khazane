<template>
    ...
    >
        <template v-slot="{ modal }">
            ...
            >
                <div
                    class="relative rounded-s-lg shadow-sm bg-action-secondary dark:bg-dark-action-secondary h-full flex flex-col transition-transform"
                    :class="{
...
const warehouse = ref(new WareHouse(0));
...
const onClose = () => {
    if (warehouse.value) {
        warehouse.value = new WareHouse(0);
    }
